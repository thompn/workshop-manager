    ...
    <div className="container mx-auto p-4 print-container">
      ...
      <style jsx global>{`
        @media print {
          ...
          .print-show {
            display: block !important; /* Ensure this is effective for print */
          }
          ...
          .print-table {
            font-size: 9pt; /* Adjusted for potentially more columns */
            color: #000 !important; 
          }
          ...
          .print-cell input[type="number"] {
            display: none !important;
          }
          .print-only-physical-count {
            display: inline !important; 
          }
          .print-only-physical-count:empty::after {
            content: "_____";
            color: #aaa;
          }
          .print-physical-count-cell,
          .print-discrepancy-cell,
          .print-physical-count-header,
          .print-discrepancy-header,
          .print-summary-row td,
          .print-summary-row th {
             display: table-cell !important; 
          }
        }
        /* Add base style for print-show to be hidden on screen */
        .print-show {
          display: none;
        }
      `}</style>
