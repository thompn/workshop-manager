  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full">
      <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
        <h3 className="text-lg font-medium leading-6 text-gray-900 dark:text-white mb-4">Add New Story</h3>
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="storyName" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Story Name</label>
            <input
              type="text"
              id="storyName"
              value={storyName}
          ...
          <div className="mb-4">
            <label htmlFor="storyDescription" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Description</label>
            <textarea
              id="storyDescription"
